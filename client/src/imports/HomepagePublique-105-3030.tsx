import svgPaths from "./svg-91w1ndvmbj";
    ...
    <div className="relative shrink-0 size-[15px]" data-name="Features Dropdown Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="Features Dropdown Icon">
          <path d={svgPaths.p35b0db80} id="Chevron down" stroke="var(--stroke-0, #303044)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.125" />
        </g>
      </svg>
    </div>
  );
